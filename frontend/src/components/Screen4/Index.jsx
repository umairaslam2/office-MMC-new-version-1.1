...
const Screen4 = () => {
  ...
  const deleteHandler = async (data) => {
    ...
    setLoading(true)
    try {
      const res = await axios.post(`${base_URL}/api/screen4images/manage`, {
        id: data?.ID,
        action: "DELETE"
      });
  ...
  return (
    <ImageUploadPage
      title="Screen 4 Images"
      inputLabel="Image Order"
      showUpload={true}
      columns={columns}
      data={data}
      setReRendering={setReRendering}
      purpose="screen4Images"
      addRoute="api/screen4images/manage"
      editRoute="api/screen4images/manage"
